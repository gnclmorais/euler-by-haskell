...
--iterateMx _ [] = []
--iterateMx n (x:y:z:q:xs)
--    | null xs =
--    otherwise =
--iterateMx n _ = error "The matrix is not big enough"


--maxValue :: [[Int]] -> Int -> State Int ()
--maxValue m a =
--    forM_ [0..(length m)] $ \i ->
--        forM_ [0..(length m)] $ \j ->
--            forM_ [0..3] $ \k ->
...
-- Main section
main = do
    let list = [[08, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 08],
